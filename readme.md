# Ola [![gzip size](https://img.badgesize.io/franciscop/ola/master/ola.min.js.svg?compression=gzip&label=size)](https://github.com/franciscop/ola/blob/master/ola.min.js) [![test status](https://wdp9fww0r9.execute-api.us-west-2.amazonaws.com/production/badge/franciscop/ola?label=test&logo=none)](https://github.com/franciscop/ola/actions) [![npm install ola](https://img.shields.io/badge/npm%20install-ola-blue.svg)](https://www.npmjs.com/package/ola)
